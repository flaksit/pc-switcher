...
- [x] 02-21-PLAN.md — rework VM integration for the new job/review shape; add apt-repository-state coverage closing broken-window #2 [wave 6]
...
| 2. Package Management Sync | 23/23 | In Progress|  |
