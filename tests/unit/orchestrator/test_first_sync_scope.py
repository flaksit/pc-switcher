...
class TestFirstSyncScopesPackageJobsOrdering:
    ...
    def test_manual_flatpak_sync_announces_the_refs_it_would_replay(self, mock_config: MagicMock) -> None:
        """G124 — the third unreproducible job announces its own scope, naming the flatpak refs
        no remote can supply rather than the packages or paths the other two speak for."""
