...
class TestBtrfsSnapshotJobCreation:
    ...
    async def test_001_core_fr_snap_pre(
        ...
        """CORE-FR-SNAP-PRE: System MUST create read-only btrfs snapshots before any job executes.
    ...
    async def test_001_core_fr_snap_post(
        ...
        """CORE-FR-SNAP-POST: System MUST create post-sync snapshots after all jobs complete.
    ...
    async def test_001_core_fr_snap_name(
        ...
        """CORE-FR-SNAP-NAME: Snapshot naming MUST follow pattern {pre|post}-<subvolume>-<timestamp>.
    ...
    async def test_001_core_fr_snap_always(
        ...
        """CORE-FR-SNAP-ALWAYS: Snapshot management MUST be always active (not configurable).
...
class TestBtrfsSnapshotJobErrorHandling:
    ...
    async def test_001_core_fr_snap_fail(
        ...
        """CORE-FR-SNAP-FAIL: If pre-sync snapshot creation fails, system MUST abort.
...
class TestBtrfsSnapshotJobValidation:
    ...
    async def test_001_core_fr_subvol_exist(
        ...
        """CORE-FR-SUBVOL-EXIST: System MUST verify configured subvolumes exist before snapshots.
    ...
    async def test_001_core_fr_snapdir(
        ...
        """CORE-FR-SNAPDIR: System MUST verify /.snapshots/ is a subvolume.
