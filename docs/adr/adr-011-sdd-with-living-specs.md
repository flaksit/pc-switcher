...
- Do not remove items; bar them out and mark as deprecated (removed and nothing replaces it) or superseded (removed and replaced by something completely different that we should not cover by a change of the current item).
