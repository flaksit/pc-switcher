...
- [package-sync.md](jobs/package-sync.md) - The five package jobs (`apt_sync`, `snap_sync`, `flatpak_sync`, `manual_deb_sync`, `manual_installs_sync`): item -> diff -> review -> converge, per-manager review, machine-specific packages, install snippets
