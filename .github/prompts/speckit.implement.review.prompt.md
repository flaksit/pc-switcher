...
Review the implementation. Verify if the current state of the project implements the spec completely and correctly. Write your feedback to a new file named "implementation-review.md" in the feature folder so I can feed it back to my developer so they can fix their work.
