...
### Output
Write a report to a new file "plan-review-N-resolved.md", where N is the same number as of the review file you read. The goal is to have a trace of any decisions we make while resolving the feedback. The report should contain the following:
- $EXTRA_INSTRUCTIONS
